 ...
 */
class Books extends \LibraryBundle\Entity\Books implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LibraryBundle\\Entity\\Books' . "\0" . 'id', '' . "\0" . 'LibraryBundle\\Entity\\Books' . "\0" . 'titre', '' . "\0" . 'LibraryBundle\\Entity\\Books' . "\0" . 'auteur', '' . "\0" . 'LibraryBundle\\Entity\\Books' . "\0" . 'categorie'];
        }
