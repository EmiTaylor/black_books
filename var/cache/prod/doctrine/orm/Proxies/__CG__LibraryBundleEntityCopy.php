 ...
 */
class Copy extends \LibraryBundle\Entity\Copy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LibraryBundle\\Entity\\Copy' . "\0" . 'id', '' . "\0" . 'LibraryBundle\\Entity\\Copy' . "\0" . 'status', '' . "\0" . 'LibraryBundle\\Entity\\Copy' . "\0" . 'prix', '' . "\0" . 'LibraryBundle\\Entity\\Copy' . "\0" . 'etat', '' . "\0" . 'LibraryBundle\\Entity\\Copy' . "\0" . 'books'];
        }
