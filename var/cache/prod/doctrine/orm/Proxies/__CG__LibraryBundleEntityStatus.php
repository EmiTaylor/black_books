 ...
 */
class Status extends \LibraryBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LibraryBundle\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'LibraryBundle\\Entity\\Status' . "\0" . 'rayon', '' . "\0" . 'LibraryBundle\\Entity\\Status' . "\0" . 'categorie', '' . "\0" . 'LibraryBundle\\Entity\\Status' . "\0" . 'vendu', '' . "\0" . 'LibraryBundle\\Entity\\Status' . "\0" . 'emprunter'];
        }
    ...
    public function setEmprunter($emprunter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmprunter', [$emprunter]);

        return parent::setEmprunter($emprunter);
    }
    ...
    public function getEmprunter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmprunter', []);

        return parent::getEmprunter();
    }
